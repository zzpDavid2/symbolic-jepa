...
# %% [markdown]
# # Decoupled model / data seeds — `jepa_constant_aug_decoupled_v1`
#
...
EXPERIMENT_VERSION = 'jepa_constant_aug_decoupled_v1'
...
# Model-side randomness: init, dropout, optimiser, DataLoader shuffle.
MODEL_SEEDS = [42, 123, 7, 3095, 4003, 492, 4550, 6928]
